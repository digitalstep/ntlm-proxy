...
public final class ProxySelectorUtils {
	 ...
	 * 
	 * @return <code>List&lt;Proxy&gt;</code> an immutable list containing the
	 *         <code>Proxy.NO_PROXY</code> element only;
	 */
	 ...
	 * @return
	 */
	private static Proxy createProxy(Proxy.Type type, String host, int port) {
